...
WHERE K.decX IS NOT NULL AND K.decY IS NOT NULL AND K.strPunkttyp='Ansluten byggnad' or K.strPunkttyp='Inventeringsinfo' or K.strPunkttyp='Efterföljande re'
